<#
.SYNOPSIS
Run this branch instead of the installed Lemonade, without uninstalling it.
...
.EXAMPLE
  .\scripts\dev-run.ps1
  .\scripts\dev-run.ps1 -Store C:\temp\sysstore
  .\scripts\dev-run.ps1 -Restore
#>
[CmdletBinding()]
param(
...
Write-Host "To go back:  .\scripts\dev-run.ps1 -Restore"
